...
echo "*******************************************************"
echo "* Fixing 24 VMs PMD / CPU Affinity for PV-VV-VV-VV-VP *"
echo "*******************************************************"
echo ""
...
cpu_list=1,2,5,7,9,11,13,15,19,21,23,25,27,29,31,35,37,39,41,43,45,47,51,53,55,65,66,69,71,73,75,77,79,83,85,87,89,91,93,95,99,101,103,105,107,109,111,115,117,119
