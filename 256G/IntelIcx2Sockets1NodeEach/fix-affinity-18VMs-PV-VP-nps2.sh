...
echo "*******************************************************"
echo "* Fixing 18 VMs PMD / CPU Affinity for PV-VV-VV-VV-VP *"
echo "*******************************************************"
echo ""
...
cpu_list=37,38,41,43,45,47,49,51,53,55,57,59,61,63,65,67,69,71,3,109,110,113,115,117,119,121,123,125,127,129,131,133,135,137,139,141,143,75
