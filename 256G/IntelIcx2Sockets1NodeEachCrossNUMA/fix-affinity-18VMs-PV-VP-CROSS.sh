...
echo "*****************************************************"
echo "* Fixing 18VMs PMD / CPU Affinity for PV-VV-VV-VV-VP *"
echo "*****************************************************"
echo ""
...
cpu_list=3,5,6,10,11,14,15,19,23,27,31,35,39,43,47,51,55,59,63,67,69,70,74,78,75,79,83,87,91,95,99,103,107,111,115,119,123,127
