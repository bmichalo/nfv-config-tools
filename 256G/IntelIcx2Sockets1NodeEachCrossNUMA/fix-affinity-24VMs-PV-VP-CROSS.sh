...
echo "*****************************************************"
echo "* Fixing 23VMs PMD / CPU Affinity for PV-VV-VV-VV-VP *"
echo "*****************************************************"
echo ""
...
cpu_list=3,5,6,10,11,14,15,18,19,22,23,26,27,30,31,34,35,38,39,43,47,51,55,59,63,67,69,70,74,75,78,79,82,83,86,87,90,91,94,95,98,99,102,103,107,111,115,119,123,127
