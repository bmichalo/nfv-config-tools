...
ovs) #switch configuration
	...
	# 		ovs_ports=6
			...
			vhost_port="vm26-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			#
			# vhost-user bridge pv,vv,vp
			#
			phy_br="phy-br-1"
			log "phy_br = $phy_br"
			
			vhost_port="vm0-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm1-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			#
			# vhost-user bridge pv,vv,vv,vp
			#
			phy_br="phy-br-2"
			log "phy_br = $phy_br"
			
			vhost_port="vm1-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm2-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			#
			# vhost-user bridge pv,vv,vv,vv,vp
			#
			phy_br="phy-br-3"
			log "phy_br = $phy_br"
			
			vhost_port="vm2-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm3-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			#
			# vhost-user bridge pv,vv,vv,vv,vv,vp
			#
			phy_br="phy-br-4"
			log "phy_br = $phy_br"
			
			vhost_port="vm3-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm4-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			#
			# vhost-user bridge pv,vv,vv,vv,vv,vv,vp
			#
			phy_br="phy-br-5"
			log "phy_br = $phy_br"
			
			vhost_port="vm4-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm5-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			#
			# vhost-user bridge pv,vv,vv,vv,vv,vv,vv,vp
			#
			phy_br="phy-br-6"
			log "phy_br = $phy_br"
			
			vhost_port="vm5-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm6-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			#
			# vhost-user bridge pv,vv,vv,vv,vv,vv,vv,vv,vp
			#
			phy_br="phy-br-7"
			log "phy_br = $phy_br"
			
			vhost_port="vm6-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm7-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			#
			# vhost-user bridge pv,vv,vv,vv,vv,vv,vv,vv,vv,vp
			#
			phy_br="phy-br-8"
			log "phy_br = $phy_br"
			
			vhost_port="vm7-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm8-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			#
			# vhost-user bridge pv,vv,vv,vv,vv,vv,vv,vv,vv,vv,vp
			#
			phy_br="phy-br-9"
			log "phy_br = $phy_br"
			
			vhost_port="vm8-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm9-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm9-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm10-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm10-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm11-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm11-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm12-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm12-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm13-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm13-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm14-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm14-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm15-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm15-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm16-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm16-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm17-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm17-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm18-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm18-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm19-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm19-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm20-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm20-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm21-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm21-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm22-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm22-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm23-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm23-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm24-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm24-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm25-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm25-vhost-user-1-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			vhost_port="vm26-vhost-user-0-n$pci_node"
			log "vhost_port = $vhost_port"
			...
			for i in `seq 0 1`; do
				...
				if [ -z "$overlay_network" -o "$overlay_network" == "none" -o "$overlay_network" == "half-vxlan" -a $i -eq 1 ]; then
					...
					if [ "$overlay_network" == "vxlan" -o "$overlay_network" == "half-vxlan" -a $i -eq 0 ]; then
						log "BILL:  Inside overlay network code"
						vxlan_br="vxlan-br-$i"
		...
		case $topology in
			...
			for this_dev in `echo $devs | sed -e 's/,/ /g'`; do
				...
				if [ $rhel_major_version -eq 8 ]; then
					...
					vf_eth_name=`/bin/ls /sys/bus/pci/devices/"$vf_loc"/net | grep ens`
				else
